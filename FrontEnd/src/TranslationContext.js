...
const translations = {
  en: {
    ...
    purchase: "Thank you for your purchase. Your order is being processed.",
    ...
    creatNewProd: "Create New Product",
    ...
    enterpass: "Enter a new password to update your password",
  ...
  ar: {
    ...
    yourOrder: "طلاباتك",
    noOrd: "لا توجد أي طلبات",
    orderdate: "تاريخ الطلب",
    product: "المنتج",
    deleteAdd: "هل أنت متأكد أنك تريد حذف هذا العنوان؟",
    shippingAdd: "عنوان الشحن",
    fullName: "الأسم بالكامل",
    checkoutCon: "متابعة الدفع",
    orderSum: "ملخص الطلب",
    successOrder: "!تم تقديم الطلب بنجاح",
    purchase: "شكرًا لشرائك. طلبك قيد المعالجة.",
    ...
    creatNewProd: "إنشاء المنتج جديد",
    createnewadmin: "إنشاء مشرف جديد",
    ...
    enterpass: "أدخل كلمة مرور جديدة لتحديث كلمة مرورك",
    entermail: "الرجاء إدخال بريدك الإلكتروني",
